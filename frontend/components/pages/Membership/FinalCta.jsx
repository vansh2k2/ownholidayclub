...
export default function FinalCta({ onScrollToTiers }) {
      ...
      <div className="relative z-10 max-w-xl mx-auto">
        <ScrollAnimate animation="fade-up">
          ...
          >
            ...
            <br />
            <em className="font-light text-white not-italic">Legacy.</em>
          </h2>
          ...
          >
            Join 70,000+ members who have secured a lifetime of extraordinary vacations.
          </p>
          ...
          >
            ...
            <span className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center transition-all duration-300">
