...
const photos = [
  { src: "img1.jpg", label: "Professional Setup" },
  { src: "img2.jpg", label: "Executive Lounge" },
  { src: "img3.jpg", label: "Event Highlights" },
];

export default function Gallery({ serviceData, onImageError }) {
  const [zoomSrc, setZoomSrc] = useState(null);

  const gallery = serviceData?.gallery?.map((src, i) => ({
    src,
    label: `Photo ${i + 1}`,
  })) ?? photos;
    ...
    <>
      ...
      >
        ...
        <div className="text-center mb-10 px-4">
          ...
          >
            Portfolio{" "}
            <em className="font-light text-amber-700 not-italic">Showcase</em>
          </h2>
          ...
          <p
            ...
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            Experience our service excellence through our lens
          </p>
        </div>

        {/* Masonry Grid */}
        <div
          className="w-full px-2 site-width mx-auto"
          style={{
            columns: "3 280px",
            gap: "10px",
          }}
