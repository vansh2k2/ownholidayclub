...
export default function Hero() {
  ...
  const backgroundImage = heroData?.backgroundImage || "/about.jpg";
  const altText = heroData?.imageAltText || "About Us";
  const title = heroData?.title || "About";
  const highlightedText = heroData?.highlightedText || "Us.";
  const shortDescription = heroData?.shortDescription || "Discover our heritage and the legacy of hospitality we bring to every journey.";
