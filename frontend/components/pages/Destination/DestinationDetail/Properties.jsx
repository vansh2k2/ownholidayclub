        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
          <ScrollAnimate animation="reveal-left">
            ...
            <p className="text-slate-500 text-lg max-w-xl">
              Exclusive resorts in the {destinationData.name} that meet the
              rigorous Platinum Standard of the Own Holiday Club.
            </p>
          </ScrollAnimate>
          ...
          <ScrollAnimate animation="reveal-right">
            ...
            >
              View All {destinationData.name} Resorts <ArrowRight size={14} />
            </button>
          </ScrollAnimate>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {destinationData.properties.map((prop, idx) => (
            <ScrollAnimate
            ...
            >
              <div
                onClick={() => setActiveModal({ type: "property", data: prop })}
